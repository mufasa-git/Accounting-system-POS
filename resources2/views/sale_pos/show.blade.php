...
<div class="modal-body">
  ...
  <div class="modal-footer">
    <a href="#" class="print-invoice btn btn-primary" data-href="{{route('sell.printInvoice', [$sell->id, "USD"])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print_usd")</a>
    <a href="#" class="print-invoice btn btn-primary" data-href="{{route('sell.printInvoice', [$sell->id, "IQD"])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print_iqd")</a>
